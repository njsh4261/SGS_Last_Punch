...
class SettingsViewController: UITableViewController {
    ...
    private var userInfo = User(senderId: "-1", displayName: "별명", name: "김스낵", email: "test.gamil.com", description: "설명", phone: "010-1234-1234", country: "kor", language: "kor", settings: 0, status: "대화 가능", createDt: "2022-02-25T12:00:00", modifyDt: "2022-02-25T12:00:00")
