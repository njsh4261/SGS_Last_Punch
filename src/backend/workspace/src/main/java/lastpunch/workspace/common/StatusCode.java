...
public enum StatusCode{
    ...
    ACCOUNT_NOT_EXIST(HttpStatus.OK, "12002", "ACCOUNT_NOT_EXIST", "Snack 사용자가 아닙니다"),
    CHANNEL_NOT_EXIST(HttpStatus.OK, "12003", "CHANNEL_NOT_EXIST", "존재하지 않는 채널입니다"),
    ACCOUNTWORKSPACE_NOT_EXIST(HttpStatus.OK, "12004", "ACCOUNTWORKSPACE_NOT_EXIST", "워크스페이스 멤버가 압니다"),
    ACCOUNTWORKSPACE_ALREADY_EXIST(HttpStatus.OK, "12005", "ACCOUNTWORKSPACE_ALREADY_EXIST", "이미 워크스페이스 멤버입니다"),
    ACCOUNTCHANNEL_NOT_EXIST(HttpStatus.OK, "12006", "ACCOUNTCHANNEL_NOT_EXIST", "채널의 멤버가 아닙니다"),
    ACCOUNTCHANNEL_ALREADY_EXIST(HttpStatus.OK, "12007", "ACCOUNTCHANNEL_ALREADY_EXIST", "이미 채널에 속한 멤버입니다"),
    ...
    CHANNEL_ALREADY_EXIST(HttpStatus.OK, "12012", "CHANNEL_ALREADY_EXIST", "동일한 채널이 존재합니다"),
