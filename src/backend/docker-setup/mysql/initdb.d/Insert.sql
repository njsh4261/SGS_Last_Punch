...
INSERT INTO account (email, password, name, country, language, settings, status, createDt, modifyDt)
    VALUES ('1', '$2a$10$eU4gRbKP1WWUczJpH9BI5.CEmdyROfZoAOFJYRzeUFp.UPgW766Ku', 'Saitama', 'kor', 'eng', 1, 2, '1234-01-01', '9999-12-31');
INSERT INTO account (email, password, name, country, language, settings, status, createDt, modifyDt)
    VALUES ('asdf@asdf', '$2a$10$BkGjbK/UK9NiwgWEvYdRoedRDPhP1Nhh/ttog4eI8eBdvq3CCXhJC', 'Superman', 'kor', 'eng', 1, 2, '1234-01-01', '9999-12-31');
INSERT INTO account (email, password, name, country, language, settings, status, createDt, modifyDt)
...
INSERT INTO account (email, password, name, country, language, settings, status, createDt, modifyDt)
    VALUES ('2222@asdf', '$2a$10$BkGjbK/UK9NiwgWEvYdRoedRDPhP1Nhh/ttog4eI8eBdvq3CCXhJC', 'Ironman', 'kor', 'eng', 1, 2, '1234-01-01', '9999-12-31');
INSERT INTO account (email, password, name, country, language, settings, status, createDt, modifyDt)
...
INSERT INTO account (email, password, name, country, language, settings, status, createDt, modifyDt)
    VALUES ('6666@asdf', '$2a$10$BkGjbK/UK9NiwgWEvYdRoedRDPhP1Nhh/ttog4eI8eBdvq3CCXhJC', 'Hawkeye', 'kor', 'eng', 1, 2, '1234-01-01', '9999-12-31');
INSERT INTO account (email, password, name, country, language, settings, status, createDt, modifyDt)
    VALUES ('7777@asdf', '$2a$10$BkGjbK/UK9NiwgWEvYdRoedRDPhP1Nhh/ttog4eI8eBdvq3CCXhJC', 'Black Widow', 'kor', 'eng', 1, 2, '1234-01-01', '9999-12-31');
