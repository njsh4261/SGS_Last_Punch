...
INSERT INTO account (email, password, name, country, language, status, createDt, modifyDt)
    VALUES ('1', '$2a$10$eU4gRbKP1WWUczJpH9BI5.CEmdyROfZoAOFJYRzeUFp.UPgW766Ku', 'Saitama', 'kor', 'eng', 2, '1234-01-01', '9999-12-31');
INSERT INTO account (email, password, name, country, language, status, createDt, modifyDt)
    VALUES ('asdf@asdf', '$2a$10$BkGjbK/UK9NiwgWEvYdRoedRDPhP1Nhh/ttog4eI8eBdvq3CCXhJC', 'Superman', 'kor', 'eng', 2, '1234-01-01', '9999-12-31');
INSERT INTO account (email, password, name, country, language, status, createDt, modifyDt)
    VALUES ('qwer@qwer', '$2a$10$BkGjbK/UK9NiwgWEvYdRoedRDPhP1Nhh/ttog4eI8eBdvq3CCXhJC', 'Batman', 'kor', 'eng', 2, '1234-01-01', '9999-12-31');
INSERT INTO account (email, password, name, country, language, status, createDt, modifyDt)
    VALUES ('zxcv@zxcv', '$2a$10$BkGjbK/UK9NiwgWEvYdRoedRDPhP1Nhh/ttog4eI8eBdvq3CCXhJC', 'Spider-man', 'kor', 'eng', 2, '1234-01-01', '9999-12-31');

INSERT INTO account (email, password, name, country, language, status, createDt, modifyDt)
    VALUES ('1111@asdf', '$2a$10$BkGjbK/UK9NiwgWEvYdRoedRDPhP1Nhh/ttog4eI8eBdvq3CCXhJC', 'Captain America', 'kor', 'eng', 2, '1234-01-01', '9999-12-31');
INSERT INTO account (email, password, name, country, language, status, createDt, modifyDt)
    VALUES ('2222@asdf', '$2a$10$BkGjbK/UK9NiwgWEvYdRoedRDPhP1Nhh/ttog4eI8eBdvq3CCXhJC', 'Ironman', 'kor', 'eng', 2, '1234-01-01', '9999-12-31');
INSERT INTO account (email, password, name, country, language, status, createDt, modifyDt)
    VALUES ('3333@asdf', '$2a$10$BkGjbK/UK9NiwgWEvYdRoedRDPhP1Nhh/ttog4eI8eBdvq3CCXhJC', 'Wonder Woman', 'kor', 'eng', 2, '1234-01-01', '9999-12-31');
INSERT INTO account (email, password, name, country, language, status, createDt, modifyDt)
    VALUES ('4444@asdf', '$2a$10$BkGjbK/UK9NiwgWEvYdRoedRDPhP1Nhh/ttog4eI8eBdvq3CCXhJC', 'Deadpool', 'kor', 'eng', 2, '1234-01-01', '9999-12-31');

INSERT INTO account (email, password, name, country, language, status, createDt, modifyDt)
    VALUES ('5555@asdf', '$2a$10$BkGjbK/UK9NiwgWEvYdRoedRDPhP1Nhh/ttog4eI8eBdvq3CCXhJC', 'Antman', 'kor', 'eng', 2, '1234-01-01', '9999-12-31');
INSERT INTO account (email, password, name, country, language, status, createDt, modifyDt)
    VALUES ('6666@asdf', '$2a$10$BkGjbK/UK9NiwgWEvYdRoedRDPhP1Nhh/ttog4eI8eBdvq3CCXhJC', 'Hawkeye', 'kor', 'eng', 2, '1234-01-01', '9999-12-31');
INSERT INTO account (email, password, name, country, language, status, createDt, modifyDt)
    VALUES ('7777@asdf', '$2a$10$BkGjbK/UK9NiwgWEvYdRoedRDPhP1Nhh/ttog4eI8eBdvq3CCXhJC', 'Black Widow', 'kor', 'eng', 2, '1234-01-01', '9999-12-31');
INSERT INTO account (id, email, password, name, country, language, status, createDt, modifyDt)
    VALUES (123456789123456, 'test@test', '$2a$10$BkGjbK/UK9NiwgWEvYdRoedRDPhP1Nhh/ttog4eI8eBdvq3CCXhJC', 'Big Integer Man', 'kor', 'eng', 2, '1234-01-01', '9999-12-31');
